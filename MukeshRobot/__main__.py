...
buttons =[
    [
        InlineKeyboardButton(
            text="❣️ Aᴅᴅ Mᴇ ᴛᴏ Yᴏᴜʀ Gʀᴏᴜᴘ ❣️",
            url=f"https://t.me/{dispatcher.bot.username}?startgroup=true",
        ),
    ],
    [
        InlineKeyboardButton(text="⌨️ ʜᴇʟᴘ ᴀɴᴅ ᴄᴏᴍᴍᴀɴᴅs", callback_data="Main_help"),
    ],
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            x=update.effective_message.reply_sticker(
                "CAACAgUAAx0CdVhmXwABAiEhZLFrRD9Di-t9XfNWVkuQpuudaEgAAtsJAALOHZBVntJm5ykwboEvBA")
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs 🍷", url=f"https://t.me/Nikky_Support"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(text="Dᴏɴᴀᴛɪᴏɴ 🎉", url=f"https://t.me/jaanxd_01") 
                    ],
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5615344987 and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [ɢɪᴛʜᴜʙ](https://github.com/jatindalal875/Managementhu)"
                ...
                [
                    [
                        InlineKeyboardButton(
                            ...
                            url="https://t.me/ElenaMusicRobot?startgroup=true"
                            )
                       ]
                ]
                     )
